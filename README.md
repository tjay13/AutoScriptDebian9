...
sudo apt-get -y install wget && sudo wget https://raw.githubusercontent.com/tjay13/AutoScriptDebian9/main/Debian9.sh && sudo chmod +x Debian9.sh && sudo ./Debian9.sh && rm -f Debian9.sh && history -c
